...
@section('content')
            ...
            <div class="col-md-12">
                ...
                <form class="form" action="" id="addCheckForm">
                    <div class="row">
                        ...
                        <input type="hidden" name="schedate" value="{{ $data['schedate'] }}">
                        <input type="hidden" name="prd_no" value="{{ $data['prd_no'] }}">
                        <div class="col-md-1">
                            <div class="form-group">
                                <label for="snm" class="control-label">圖號</label>
                                <input type="text" class="form-control" readonly value="{{ $data['snm'] }}">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                        ...
                        <div class="col-md-1">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="glassProdLineID" readonly value="{{ $data['glassProdLineID'] }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="other" rows="4" style="resize: none;"></textarea>
                            </div>
                        </div>
                        <div class="col-md-8">
                            <div class="form-group">
                                <label for="" class="control-label">備註</label>
                                <textarea class="form-control" name="remark" rows="4" style="resize: none;"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="guage" class="control-label">量規</label>
                                <input type="text" class="form-control" name="guage" value="">
                            </div>
                        </div>
                        <div class="col-md-1">
                            <div class="form-group">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="predictQuantity" value="">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
    ...
    <script src="{{ url('/js/check/addCheck.js?v=8') }}"></script>
@endsection