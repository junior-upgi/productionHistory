<div class="modal fade" id="addSpotCheckDefectModal" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">新增抽驗缺點記錄</h4>
            </div>
            <form class="form-horizontal" id="addSpotCheckDefectForm" role="form">
                            ...
                            <div class="panel panel-default" v-for="item in spotCheckItems"
                                ...
                                <div class="panel-heading" role="tab">
                                    <h4 class="panel-title">
                                        <a data-toggle="collapse" v-bind:href="'#s_add_' + item.itemID"
                                           aria-expanded="true" v-bind:aria-controls="item.itemID">
                                            <span>@{{ item.itemName }}</span>
                                        </a>
                                    </h4>
                                </div>
                                <div v-bind:id="'s_add_' + item.itemID" class="panel-collapse collapse" role="tabpanel">
