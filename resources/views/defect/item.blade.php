...
<div id="item">
            ...
            <div class="row">
                <div class="pull-right col-md-5">
                    <div class="input-group">
                        <input type="text" id="search_name" class="form-control input-sm" placeholder="缺點上層項目名稱" value="">
    ...
    @include('defect.addItem')
</div>
<script src="{{ url('js/defect/item.js?v=4') }}"></script>
@endsection